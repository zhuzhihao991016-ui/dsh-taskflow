...
export const RUN_TRANSITIONS: Readonly<Record<RunStatus, readonly RunStatus[]>> = {
  ...
  READY: ['EXECUTING', 'WAITING_PERMISSION', 'CANCELLED', 'FAILED'],
  EXECUTING: ['PLANNING', 'INTEGRATION_REVIEW', 'WAITING_PERMISSION', 'WAITING_DECISION', 'PAUSED', 'FAILED', 'CANCELLED'],
  INTEGRATION_REVIEW: ['PLANNING', 'AWAITING_HUMAN', 'EXECUTING', 'WAITING_DECISION', 'FAILED', 'CANCELLED'],
  WAITING_PERMISSION: ['EXECUTING', 'CANCELLED', 'FAILED'],
  WAITING_DECISION: ['PLANNING', 'READY', 'EXECUTING', 'INTEGRATION_REVIEW', 'CANCELLED', 'FAILED'],
  PAUSED: ['EXECUTING', 'WAITING_PERMISSION', 'CANCELLED', 'FAILED'],
  AWAITING_HUMAN: ['ACCEPTED', 'PLANNING', 'CANCELLED'],
  FAILED: ['PLANNING', 'EXECUTING', 'INTEGRATION_REVIEW'],
  ACCEPTED: [],
  CANCELLED: [],
}

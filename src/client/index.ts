 ...
 * polls the host's same-origin `/plugins/taskflow/state` endpoint and shows
 * how many workflow runs are active. P0 read-only projection: all writes go
 * through the host's controlled routes (submit/command).
